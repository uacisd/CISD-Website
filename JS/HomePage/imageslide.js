{
        ...
        navigate(dir = 'next') {
            ...
            const animateSlides = () => {
                return new Promise((resolve, reject) => {
                    ...
                    var check = newSlide.querySelector('.slide__title');
                    if (check == null){
                        anime({
                            targets: [newSlide.querySelector('.title1'), newSlide.querySelector('.theme')],
                            duration: this.settings.animation.slides.duration,
                            easing: this.settings.animation.slides.easing,
                        ...
                        anime({
                            targets: [newSlide.querySelector('.title2'), newSlide.querySelector('.p2')],
                            duration: this.settings.animation.slides.duration,
                            easing: this.settings.animation.slides.easing,
                            delay: (t,i,total) => dir === 'next' ? i*100+750 : (total-i-1)*100+750,
                            translateY: [dir === 'next' ? 300 : -300,0],
    ...
    //force reload go back to the top of the page
